...
public class Spawner {
	...
	public Spawner(Handler handler, float x, float y, int z, int room) {
	...
	public void spawnZombie(int id, float dspeed, int health) {
		...
		Zombie zombie = new Zombie(handler, id, x, y, z, speed, health);
		zombie.tick();
	...
	public void spawnLicker(int id, float dspeed, int health) {
		handler.getWorld().getEntityManager().addZombie(new Licker(handler, id, x, y, z, dspeed, health));
	}
	
	public void spawnToxen(int id, float dspeed, int health) {
		handler.getWorld().getEntityManager().addZombie(new Toxen(handler, id, x, y, z, dspeed, health));
	}
	
	public void spawnStoker(int id, float dspeed, int health) {
		handler.getWorld().getEntityManager().addZombie(new Stoker(handler, id, x, y, z, dspeed, health));
	}
