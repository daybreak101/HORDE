...
public class OnlineLuna extends Entity{
	...
	public OnlineLuna(Handler handler, String owner) {
		super(handler, 0, 0, -1, Creature.DEFAULT_CREATURE_WIDTH, Creature.DEFAULT_CREATURE_HEIGHT);
		this.owner = owner;
		...
		this.z = handler.getWorld().getEntityManager().getSpecificPlayer(owner).getZ();
	}
