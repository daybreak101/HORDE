...
public class Blessings {
	...
	public void doBlessing() {
		...
		case BlessingInventory.TELEPORT:
			...
			while (!node.withinPlayable() || findBlocked(radius) || findBlocked(player.getCollisionBounds(0, 0))) {
