...
public class Rocket extends Bullet {
	...
	public Rocket(Handler handler, float x, float y, int z, Gun gun) {
		super(handler, x, y, z, 1000, gun);
	}
	...
	public void findEntitiesInRadius() {
		...
		handler.getWorld().getEntityManager().addExplosion(new Explosion(handler, x - 150, y - 150, z, 300, 300, gunFiredFrom.isUpgraded()));
