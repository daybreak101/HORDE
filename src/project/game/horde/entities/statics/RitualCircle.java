...
public class RitualCircle extends InteractableStaticEntity {
    ...
    public void fulfillInteraction(Player player) {
        ...
        if (usedByOtherPlayer) {
            ...
            if (!handler.getBlessings().getEquipped().isEmpty()) {
    ...
    public void render(Graphics g) {
        ...
        System.out.println(usedByOtherPlayer || cooldownTimer >= cooldown);
        g.drawImage(
                (usedByOtherPlayer || cooldownTimer >= cooldown) ? Assets.ritual : Assets.ritualOff,
