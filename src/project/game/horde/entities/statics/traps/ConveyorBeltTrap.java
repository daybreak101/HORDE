...
public class ConveyorBeltTrap extends Trap {
	...
	public ConveyorBeltTrap(Handler handler, int id, float x, float y, int z, float switchX, float switchY, int switchZ, int switchRotation) {
		super(handler, id, x, y, z, 200, 200, switchX, switchY, switchZ, switchRotation, 5 * 60, 2000);
		cooldown = 30 * 60;
