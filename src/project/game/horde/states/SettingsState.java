                ...
                public void handleSelection() {
                    ...
                    switch (currentSelection) {
                        case Display.STANDARD:
                            handler.getGame().getDisplay().resetDisplay(Display.STANDARD, handler);
                            handler.getSettings().setDisplayType(Display.STANDARD);
                            break;
                        case Display.WINDOWEDFULLSCREEN:
                            handler.getGame().getDisplay().resetDisplay(Display.WINDOWEDFULLSCREEN, handler);
                            handler.getSettings().setDisplayType(Display.WINDOWEDFULLSCREEN);
                            break;
                        case Display.FULLSCREEN:
                            handler.getGame().getDisplay().resetDisplay(Display.FULLSCREEN, handler);
