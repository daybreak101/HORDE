...
public class Python extends Gun {
    ...
    public Python(Handler handler, Player player) {
        super(handler, player, GunVars.PYTHON_DAMAGE, GunVars.PYTHON_FIRERATE, GunVars.PYTHON_RELOADSPEED, GunVars.PYTHON_GUNCLIP,
                GunVars.PYTHON_MAXRESERVE, GunVars.PYTHON_WEIGHT, GunVars.PYTHON_RANGE, 90);
        this.name = GunVars.PYTHON_NAME;
        originalName = name;
        upgradedName = GunVars.PYTHON_UPGRADEDNAME;
        reloadSound = GunSounds.PYTHON_SHELL_ID;
        top = Assets.python_top;
    ...
    public void shootOnline(int x, int y, float angle, float volume) {
        ...
        Sounds.playClip(GunSounds.PYTHON_SHOT_ID, 1, volume, false);
    }
    ...
    public void shootSingleShot() {
        if (currentClip > 0 && !isReloading) {
            ...
            Sounds.playClip(GunSounds.PYTHON_SHOT_ID, 1, -1.0f, false);
